...
<head>
    ...
    <style>
        body {
            ...
            background-image: radial-gradient(circle at 50% 30%, rgba(5, 196, 107, 0.03) 0%, transparent 50%);
        }
        .hairline-border {
...
<body class="min-h-screen flex items-center justify-center p-6 antialiased">
    ...
    <div class="w-full max-w-md bg-surface p-8 rounded-2xl hairline-border shadow-2xl space-y-8">
        ...
        <div class="space-y-2 text-center">
            ...
            <h1 class="text-2xl font-bold text-white tracking-tight">Daftar Akun Baru</h1>
            <p class="text-xs text-subtle font-mono">DAFTAR CEPAT DENGAN GOOGLE OAUTH</p>
        </div>
        ...
        <!-- Google OAuth CTA (Utama, Sama Seperti Login) -->
        <div class="space-y-3">
            ...
            <div class="relative flex items-center justify-center py-2">
                ...
                <span class="relative bg-surface px-4 text-[10px] font-mono text-subtle uppercase">Atau daftar manual</span>
            </div>
        </div>
        ...
        <form method="POST" action="/register" class="space-y-4">
            ...
            <div class="space-y-1">
                <label for="name" class="block text-xs font-mono text-subtle uppercase tracking-wider">Nama Lengkap / Komunitas</label>
                <input 
                    type="text" 
                    id="name" 
                    name="name" 
                    ...
                    placeholder="Contoh: JKTDev / Budi"
                    required
                >
            </div>

            <div class="space-y-1">
                <label for="email" class="block text-xs font-mono text-subtle uppercase tracking-wider">Email Akun</label>
                <input 
                    type="email" 
                    id="email" 
                    name="email" 
            ...
            <div class="space-y-1">
                ...
                <input 
                    ...
                    name="password" 
                    class="w-full bg-canvas border border-border rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-accent transition-colors font-sans placeholder:text-subtle/40"
                    placeholder="Minimal 8 karakter, kombinasi simbol & angka"
                    required
                >
            </div>

            <div class="space-y-1">
                <label for="password_confirmation" class="block text-xs font-mono text-subtle uppercase tracking-wider">Konfirmasi Kata Sandi</label>
                <input 
                    type="password" 
            ...
            <button type="submit" class="w-full bg-surface border border-border hover:border-white text-white font-bold py-3 px-4 rounded-xl transition-all text-xs font-mono uppercase tracking-wider pt-3">
                Daftar Akun Manual
            </button>
        </form>
        ...
        <div class="text-center text-xs text-subtle font-mono pt-4 border-t border-border/60">
            Sudah memiliki akun? <a href="/login" class="text-white hover:text-accent transition-colors underline underline-offset-4">Masuk Disini</a>
        </div>
